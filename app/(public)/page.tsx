        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 max-w-xl mx-auto">
              We believe every child has unique potential. Our environment is
              designed to help them discover and develop it.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "We nurture emotional intelligence, creativity, and social skills alongside academics.",
              },
              {
                icon: Users,
                title: "Small Class Sizes",
                desc: "Smaller classes mean more individual attention and a stronger teacher-student relationship.",
              },
              {
                icon: GraduationCap,
                title: "Experienced Staff",
                desc: "Our qualified and dedicated teachers bring years of experience in early and primary education.",
              },
              {
                icon: Globe,
                title: "Safe Environment",
                desc: "A secure, child-friendly campus where students feel safe, valued and inspired to learn.",
              },
              {
                icon: Star,
                title: "Proven Track Record",
                desc: "Consistently strong academic results with many alumni excelling in top secondary schools.",
              },
